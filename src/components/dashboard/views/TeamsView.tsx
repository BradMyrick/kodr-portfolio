  ...
  const teams = [
    {
      ...
      members: [
        ...
        { user: { ...user!, id: '2', name: 'Sarah Chen', email: 'sarah@kodr.pro' }, role: 'admin' },
        { user: { ...user!, id: '3', name: 'Mike Johnson', email: 'mike@kodr.pro' }, role: 'member' }
      ],
    ...
    },
    {
      ...
      members: [
        ...
        { user: { ...user!, id: '5', name: 'Alex Rivera', email: 'alex@kodr.pro' }, role: 'owner' }
      ],
